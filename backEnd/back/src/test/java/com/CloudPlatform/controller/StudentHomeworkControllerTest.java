...
public class StudentHomeworkControllerTest<Transactional> {
    ...
    public void before() throws Exception {
        ...
        StudentHomework studentHomework = new StudentHomework(1,1, "student", "数学第一次迭代",
                date, date, "student", "一年级上数学");
        StudentHomeworkDetail studentHomeworkDetail = new StudentHomeworkDetail("1","1","student","第一次迭代做完了",correct,"做得很好",null,"/homework/sjtu1/1605603006322WechatIMG859.jpeg");
    ...
    public void getMistakenHomework() throws Exception {
        ...
        for (int i = 0 ; i < jsonArray.size(); ++i) {
            ...
            Assert.assertNotEquals(jsonObject.getJSONObject("StudentHomework").getDouble("score"), Double.valueOf(100));
        }
    }
    ...
    public void getStudentHomeworkAllOfCourse() throws Exception {
        ...
        for (int i = 0 ; i < jsonArray.size(); ++i){
            JSONObject jsonObject = jsonArray.getJSONObject(i);
            Assert.assertEquals(jsonObject.getJSONObject("StudentHomework").getInteger("courseId"), Integer.valueOf(1));
        }
    ...
    public void getStudentHomeworkOne() throws Exception {
        ...
        Assert.assertEquals(jsonObject.getJSONObject("StudentHomework").getInteger("homeworkId"), Integer.valueOf(1));
    }
    ...
    public void getPageHomeworkOfStudents() throws Exception {
        ...
        JSONArray jsonArray = JSONArray.parseArray(result);
        System.out.println(jsonArray.getJSONObject(0));
        Assert.assertEquals(jsonArray.getJSONObject(0).getJSONObject("StudentHomework").getInteger("homeworkId"), Integer.valueOf(1));
    }
    ...
    @Test
    public void editStudentHomework() {
    }

    @Test
    public void editStudentHomeworkByTeacher() {
    }

    @Test
    public void addStudentHomework() {
    }

    @Test
    public void deleteStudentHomeworkAll() {
    }

    @Test
    public void deleteStudentHomeworkOne() {
    }
