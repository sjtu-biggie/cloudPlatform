...
import 'animate.css'
import EditableTable from './change'
import {
    Card,
    Spin,
    Button,
...
const menu = (
    <Menu>
        <Menu.Item>
            <a target="_blank" rel="noopener noreferrer" href={"/home/manage/changestu"}>
                增添学生
            </a>
        </Menu.Item>
        <Menu.Item>
...
class CourseSetDemo extends React.Component {
    state = {
        step:0,
