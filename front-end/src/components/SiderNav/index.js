            ...
            menus: [
                ...
                },
                {
                    ...
                    subs: [
                        ...
                        {key: '/home/display/carousel', title: this.state.role === 'student' ? '已交' : '已收齐', icon: ''},
                        {key: '/home/display/collapse', title: this.state.role === 'student' ? '未交' : '未收齐', icon: ''},
  ...
  componentDidMount() {
    ...
    this.setState({menus:[
        ...
        },
        {
          ...
          subs: [
            {key: '/home/course/overall', title: '所有课程', icon: '',},
            {key: '/home/course/ongoing', title: this.state.role==='student'?'正在进行':'正在授课', icon: '',},
            {key: '/home/course/end', title: '已结束', icon: '',},
          ]
        },
        {
        ...
        },
        {
          ...
          subs: [
            {key: '/home/homework/overall', title: '总览', icon: ''},
            {key: '/home/homework/submitted', title: '已交', icon: ''},
            {key: '/home/homework/uncommitted', title: '未交', icon: ''},
