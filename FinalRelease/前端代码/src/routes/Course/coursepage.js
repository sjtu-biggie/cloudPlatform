...
class CoursePageDemo extends React.Component {
    ...
    getCourse = async (courseId, role, username) => {
        ...
        let config = {
            method: 'get',
            url: 'http://1.15.127.43:8787/course/getCourseById?courseId=' + courseId,
            headers: {
                withCredentials: true,
            }
        };
        ...
        let config2 = {
            method: 'get',
            url: 'http://1.15.127.43:8787/course/getCoursesByUser?userId=' + username,
            headers: {
                withCredentials: true,
            }
        };
        ...
        let config3 = {
            method: 'get',
            url: 'http://1.15.127.43:8787/course/getEndCoursesByUser?userId=' + username,
            headers: {
                withCredentials: true,
            }
        };
    ...
    getHomeworkAllByCourse = async (courseId) => {
        let config = {
            method: 'post',
            url: 'http://1.15.127.43:8383/getTeacherHomeworkAll?courseId=' + courseId,
            headers: {
                withCredentials: true,
            }
        };
    ...
    deleteBulletin = async (index) => {
        let config = {
            ...
            url: 'http://1.15.127.43:8787/course/deleteBulletin',
            headers: {
                withCredentials: true,
            }
        };
    ...
    getPageBulletin = async (page, pageSize) => {
        let config = {
            method: 'get',
            url: 'http://1.15.127.43:8787/course/getPageBulletin?courseId='
